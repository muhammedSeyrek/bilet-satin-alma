...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sqlUpdate = "UPDATE Coupons SET code = ?, discount = ?, usage_limit = ?, expire_date = ? WHERE id = ?";
        $stmt = $pdo->prepare($sqlUpdate);
        $stmt->execute([$code, $db_discount, $usage_limit, $expire_date, $kupon_id_to_edit]);
...
<html lang="tr">
<head>
    <title>Kupon Düzenle - Admin Paneli</title>
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header"><h3>Kuponu Düzenle</h3></div>
                <div class="card-body">
                    <form action="kupon_duzenle.php?id=<?= htmlspecialchars($kupon['id']) ?>" method="POST">
                        <div class="mb-3">
